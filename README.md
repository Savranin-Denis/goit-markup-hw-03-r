...
Web Studio (Version 5.0) project

HW 2

• Створи репозиторій goit-markup-hw-02 (можна через Template).

• Склонуй створений репозиторій і скопіюй в нього файли попередньої роботи (якщо
робив репозиторій не через Template).
...
Після змін, які вносите в своєму репозиторії, почекайте, будь ласка, 5 хвилин
...
«A4» У назвах файлів відсутні кирилиця, пробіли. Назви містять тільки літери і
...
«A7» Підключений нормалізатор стилів modern-normalize (мініфікована версія).
...
«B5» Імена класів не містять великих літер, чисел, пробілів, трансліту і назв
...
підключені з сервісу Google Fonts об’єднаним посиланням. Тобто в одному
посиланні одночасно підключається і Raleway, і Roboto.

«B10» В хедері та футері логотип розділений тегом <span> і акцентована частина —
“Web”.
...
«С6» Вказаний альтернативний варіанти сімейства шрифта (без зарубок) в кінці
...
«С15» Заголовок <h2> “Our Features” не стилізований/прихований. В цій ДЗ його
поки має бути видно. Приховування цього заголовка буде в наступній ДЗ.
